...
export default function Cards() {
  return (
    <div className=" font-jakarta max-w-full">
      <div className="head max-w-full w-[770px] p-4 text-center mx-auto">
      ...
      <div className="flex flex-wrap sm:justify-center md:mx-auto items-center mt-8 max-w-full w-[1180px] mx-auto justify-center ">
        ...
        <div className="card mt-3 mx-2 bg-white min-h-[422px] border border-yellow-50 shadow-[0px_4px_15px_rgba(82,82,82,0.15)] max-w-full w-[370px] justify-center block p-5 rounded-[15px]">
        ...
        <div className="mt-6 mx-auto w-[325px] mdLogmdfor:w-[300px]">
        ...
        <div className="mt-6 mx-auto w-[315px] mdLogmdfor:w-[300px]">
