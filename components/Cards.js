...
export default function Cards() {
  return (
    <div className=" font-jakarta max-w-full">
      ...
      <div className="flex items-center mt-12 max-w-full w-[1180px] mx-auto justify-between ">
        <div className="card bg-white min-h-[442px] border border-yellow-50 shadow-[0px_4px_15px_rgba(82,82,82,0.15)] max-w-full w-[370px] justify-center block p-5 rounded-[15px]">
        ...
        <div className="card bg-white min-h-[422px] border border-yellow-50 shadow-[0px_4px_15px_rgba(82,82,82,0.15)] max-w-full w-[370px] justify-center block p-5 rounded-[15px]">
